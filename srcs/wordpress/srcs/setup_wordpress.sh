...
/usr/sbin/wp core install --url=http://192.168.99.240:5050 --title=FT_SERVICES --admin_user=wp_admin --admin_password=123456 --admin_email=acortes42@student.42madrid.com --skip-email
